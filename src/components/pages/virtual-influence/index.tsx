        ...
        <div className={styles.section1}>
          <div className={styles.section1Inner}>
            ...
            <div className={styles.s1List}>
              {[1,2,3,4,5].map(item => (
               <span key={item} className={styles.s1Item}>{formatMessage({ id: `virtual-influence.section1.item${item}` })}</span>
              ))}
            </div>
          </div>
          ...
          <div className={styles.section1Inner}>
            ...
            <div className={styles.s1List}>
              {[1,2,3,4,5,6].map(item => (
               <span key={item} className={styles.s1Item}>📦 {formatMessage({ id: `virtual-influence.section2.item${item}` })}</span>
              ))}
            </div>
          </div>
        </div>
          ...
          <div className={styles.section1Inner}>
            ...
            <div className={styles.subSection}>
              ...
              <div className={styles.smallList}>
                ...
                <span key={item} className={styles.smallListItem}>{formatMessage({ id: `virtual-influence.section8.var1_item${key + 1}` })}</span>
                ))}
              </div>
            </div>
            <div className={styles.subSection}>
