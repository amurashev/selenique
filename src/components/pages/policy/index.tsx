    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые Самозанятой Мурашева
          Алёна Николаевна (далее — Оператор).
        </p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://www.selenique.space.
        </p>
        ...
        <p>
          Не допускается избыточность обрабатываемых персональных данных по
        ...
        <p>Персональные данные: электронный адрес, номера телефонов.</p>
        ...
        <p>
          Виды обработки персональных данных — отправка информационных писем на
        ...
        <p>
          ...
          направления Оператору уведомления на адрес электронной почты Оператора
          selenique.studio@gmail.com с пометкой «Актуализация персональных
          данных».
        </p>
        ...
        <p>
          ...
          selenique.studio@gmail.com с пометкой «Отзыв согласия на обработку
          персональных данных».
        </p>
        ...
        <p>
          Субъект персональных данных и/или с указанными документами. Оператор
        ...
        <p>
          ...
          Оператору с помощью электронной почты selenique.studio@gmail.com.
        </p>
        <p>
        ...
        <p>
          ...
          сети Интернет по адресу https://www.selenique.space/policy.
        </p>
      </main>
      <Footer />
    </div>
