...
const StarIcon = ({ size = 16, style }: { size: number, style?: any }) => {
  return (
    <svg style={style} version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
      width={size} height={size} viewBox="0 0 64 64" enableBackground="new 0 0 64 64">
