...
<ul>
    ...
    <li>
        clean studio lighting with sculpted shadows
    </li>
    <li>
        strong eye contact and dynamic body language
    </li>
    <li>
        a rich red fabric backdrop that instantly elevates the scene
    </li>
</ul>
...
<ul>
    ...
    <li>
        business and creative portraits
    </li>
    <li>
        fashion &amp; editorial visuals
    </li>
    <li>
        speakers, coaches, artists, founders
    </li>
    <li>
...
<ul>
    ...
    <li>
        cohesive visual style across all images
    </li>
    <li>
        easy to adapt to different faces, outfits, and moods
    </li>
    <li>
        works with any AI image generator that supports photo-style prompts and references
    </li>
</ul>
<p>This is not about random generations. It’s about having a&nbsp;<strong>reliable red studio aesthetic</strong>&nbsp;you can return to again and again.</p>
`;
